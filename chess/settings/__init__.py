...
AUTHENTICATION_BACKENDS = ('chess.apps.auth.oauth.IonOauth2',)
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'chess.apps.auth.oauth.get_username',
...
GOOGLE_DRIVE_STORAGE_JSON_KEY_FILE = os.path.join(BASE_DIR, 'settings/key.json')

GOOGLE_DRIVE_STORAGE_MEDIA_ROOT = "machine-learning-chess-project"
